...
describe('FiscalEntryService', () => {
  let service: FiscalEntryService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<FiscalEntryService>(FiscalEntryService);
  });
  ...
  describe('get', () => {
    it('deve retornar lista de entradas fiscais com sucesso', async () => {
      const mockResult = [
        {
          ETA_NUMERO: 1,
          ETA_DATA: '2026-08-15',
    ...
    it('deve aplicar filtros opcionais corretamente na query', async () => {
      ...
      expect(mockConnection.query).toHaveBeenCalledWith(
        expect.stringContaining('ETA.LOJ_CODIGO = ?'),
