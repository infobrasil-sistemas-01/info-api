...
export const FiscalEntryQuerySchema = z.object({
...
export class FiscalEntryQueryDto extends ZodDto(FiscalEntryQuerySchema) {
  @ApiPropertyOptional({
  ...
  @ApiPropertyOptional({
    description: 'Chave de acesso da NF-e (ETA_CHAVE - 44 dígitos)',
    type: String,
  })
  nfeKey?: string;
}
