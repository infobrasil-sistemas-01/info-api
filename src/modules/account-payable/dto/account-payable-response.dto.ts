...
export class AccountPayableSummaryResponseDto {
  @ApiProperty({
    example: 100,
    description: 'Número do documento de conta a pagar',
  })
  PAG_NUMERO: number;
  ...
  @ApiProperty({ example: 1500.5, description: 'Valor da conta' })
  PAG_VALOR: number;

  @ApiProperty({
    example: 'A',
    description: 'Situação (A - Aberto, L - Liquidado)',
  })
  PAG_SITUACAO: string;
...
export class AccountPayableDetailResponseDto extends AccountPayableSummaryResponseDto {
  ...
  @ApiProperty({
    example: 0,
    description: 'Valor pago por conta',
    required: false,
  })
  PAG_PORCONTA?: number;

  @ApiProperty({
    example: 'Pagamento referente à compra X',
  ...
  @ApiProperty({
    example: 0,
    description: 'Valor pago via tesouraria',
    required: false,
  })
  ...
  @ApiProperty({
    example: 1500.5,
    description: 'Valor pago via banco',
    required: false,
  })
  PAG_VALORBANCO?: number;

  @ApiProperty({ example: 1500.5, description: 'Valor total' })
  PAG_TOTAL: number;
}
